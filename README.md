...
A built-in tracking system that accumulates understanding:
...
| `templates.md` | Algorithm templates:熟练度, can they write it blindfolded? |
...
- A workspace directory pointing to this repository
...
OInspire maintains a tiered memory architecture under `memory/student/`. After **every** coaching session, the agent updates:
